...
mount SATA HDD disks for plots (4 x WD Red Pro NAS HDD 16TB SATA: RAID0 ~ 700 k=32 plots / 2 x PCIe SATA Card 2 Ports, PCI-E to SATA Expansion Card) -> /mnt/plots 
